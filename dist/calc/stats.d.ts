...
export declare const Stats: {
    ...
    calcStat(gen: Generation, stat: import("@pkmn/types").StatName, base: number, iv: number, ev: number, level: number, nature?: string | undefined): number;
    calcStatADV(natures: Natures, stat: import("@pkmn/types").StatName, base: number, iv: number, ev: number, level: number, nature?: string | undefined): number;
    calcStatRBY(stat: import("@pkmn/types").StatName, base: number, iv: number, level: number): number;
    calcStatRBYFromDV(stat: import("@pkmn/types").StatName, base: number, dv: number, level: number): number;
    ...
    getHiddenPower(gen: Generation, ivs: StatsTable<number>): {
        type: import("@pkmn/types").TypeName;
        power: number;
    };
};
